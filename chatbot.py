...
#Here I am defining that get_rude_bot_response
  ...
  bot_response_good = ["Oh, my bad! I didnt mean to make you think I care.", "Alright good talk", "oh, wait sorry, gotta take this call", "Awe man i just remembered, I've got this thing I gotta do, so yeah....Tootles!"]
